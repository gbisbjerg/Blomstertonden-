...
namespace WebService3.Controllers
{
    public class OrderedProductsController : ApiController
    {
        ...
        {
            return db.OrderedProducts.Include(x => x.FK_Order).Include(x => x.FK_Product);
        }
        ...
        public IHttpActionResult PostOrderedProduct(OrderedProduct orderedProduct)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = orderedProduct.Id }, orderedProduct);
        }
        ...
        {
            return db.OrderedProducts.Count(e => e.Id == id) > 0;
        }
    }
}